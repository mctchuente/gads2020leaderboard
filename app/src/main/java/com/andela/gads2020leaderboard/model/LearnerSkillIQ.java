 ...
 */
public class LearnerSkillIQ implements Serializable {
    @SerializedName("score")
    @Expose
    private int learnerScore;
    ...
    public int getLearnerScore() {
        return learnerScore;
    }

    public void setLearnerScore(int learnerScore) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && obj.getClass() == getClass()) {
            LearnerSkillIQ learnerSkillIQ = (LearnerSkillIQ) obj;
            if (this.learnerScore == learnerSkillIQ.getLearnerScore() && this.learnerName.equals(learnerSkillIQ.getLearnerName()) && this.learnerCountry.equals(learnerSkillIQ.getLearnerCountry())) {
                result = true;
            }
        }
        return result;
